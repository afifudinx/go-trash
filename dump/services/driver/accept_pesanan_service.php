...
try {
  ...
  if ($check['is_service'] == '1') {
    echo "<SCRIPT>alert('Transaksi gagal di terima, anda masih mempunyai pesanan yang perlu diproses');window.location='../../pesanan.php'</SCRIPT>";
    return;
  } else {
  ...
  echo "<SCRIPT>alert('Transaksi gagal di terima');window.location='../../pesanan.php'</SCRIPT>";
  return;
}
