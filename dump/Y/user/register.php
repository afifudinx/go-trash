...
<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    $usersama = mysqli_query($koneksi, "SELECT username FROM users where username = '$userName'");
    ...
    $sql = "INSERT INTO users VALUES ('$userName', '$password', '$firstName','$lastName','$email','$noHp', '$address')";
