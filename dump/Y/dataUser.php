                        ...
                        <table class="table table-bordered">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><?=$row['address'];?></td>
                                    <td>
                                        <a href="formEditDataUser.php?id=<?=$row['id_user']?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                        <a href="deleteDataUser.php?id=<?=$row['id_user']?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                    </td>
                                    <?php
                                    }
                                    ?>
