...
require('./services/admin/fetch_driver_by_username_service.php');
?>
  ...
  <header class="py-3 mb-4 border-bottom">
    <div class="container">
      <a class="px-2 text-dark text-decoration-none">
        <span class="fs-4">Detail Data Driver</span>
      </a>
    </div>
  </header>
  <main class="form-signin w-100 m-auto d-flex justify-items-center align-items-center">
    <form method="POST" action="./services/admin/update_driver_service.php?username=<?php echo "$driver_username" ?>">
      ...
      <a href="./services/admin/delete_driver_service.php?username=<?php echo "$driver_username" ?>" class='btn btn-secondary btn-lg w-100'>Delete</a>
    </form>
  </main>
</body>
