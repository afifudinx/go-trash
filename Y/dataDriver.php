                        ...
                        <table class="table table-bordered">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><?=$row['nohp'];?></td>
                                    <td>
                                        <a href="formEditDataDriver.php?id=<?=$row['id_driver']?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                        <a href="deleteDataDriver.php?id=<?=$row['id_driver']?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                    </td>
                                    <?php
                                    }
                                    ?>
